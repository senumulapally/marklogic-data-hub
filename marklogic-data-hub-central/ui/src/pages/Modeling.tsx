...
const Modeling: React.FC = () => {
  ...
  const {modelingOptions, setEntityTypeNamesArray, clearEntityModified, setView, setSelectedEntity, closeSidePanelInGraphView} = useContext(ModelingContext);
  ...
  const deleteEntityFromServer = async () => {
    ...
    try {
      ...
      toggleConfirmModal(false);
      console.log("deleting",modelingOptions.selectedEntity)
